...
// Valor aproximado de la UF para la conversión en el frontend
...
const PropertyCard: React.FC<PropertyCardProps> = ({ property, onClick }) => {
  ...
  // Logic to standardize price display: UF Main + CLP Secondary
  ...
  if (cleanCurrency === 'UF') {
    ...
    // Convert USD to CLP then estimate UF
    ...
    // Convert EUR to CLP then estimate UF
